...
void ClangTidyContext::setPreprocessor(Preprocessor *PP) {
  this->PP = PP;
}
...
std::string ClangTidyContext::getCheckName(unsigned DiagnosticID) const {
  ...
  if (!ClangWarningOption.empty())
    return "scope-diagnostic-" + ClangWarningOption;
  ...
  if (DiagLevel == DiagnosticsEngine::Note) {
    ...
    if (CheckName.empty()) {
      ...
      case DiagnosticsEngine::Fatal:
        CheckName = "scope-diagnostic-error";
        break;
      case DiagnosticsEngine::Warning:
        CheckName = "scope-diagnostic-warning";
        break;
      default:
        CheckName = "scope-diagnostic-unknown";
        break;
      }
    }
