...
// This anchor is used to force the linker to link the Gjb5369Module.
// extern volatile int Gjb5369ModuleAnchorSource;
// static int LLVM_ATTRIBUTE_UNUSED Gjb5369ModuleAnchorDestination =
//     Gjb5369ModuleAnchorSource;

// This anchor is used to force the linker to link the Gjb8114Module.
// extern volatile int Gjb8114ModuleAnchorSource;
// static int LLVM_ATTRIBUTE_UNUSED Gjb8114ModuleAnchorDestination =
//     Gjb8114ModuleAnchorSource;

// This anchor is used to force the linker to link the Gjb8114cppModule.
// extern volatile int Gjb8114cppModuleAnchorSource;
// static int LLVM_ATTRIBUTE_UNUSED Gjb8114cppModuleAnchorDestination =
//     Gjb8114cppModuleAnchorSource;

// This anchor is used to force the linker to link the ScopeModule.
extern volatile int ScopeModuleAnchorSource;
static int LLVM_ATTRIBUTE_UNUSED ScopeModuleAnchorDestination =
    ScopeModuleAnchorSource;

// extern volatile int Misrac2012ModuleAnchorSource;
// static int LLVM_ATTRIBUTE_UNUSED Misrac2012ModuleAnchorDestination =
//     Misrac2012ModuleAnchorSource;

// This anchor is used to force the linker to link the Bz12Module.
extern volatile int Bz12ModuleAnchorSource;
static int LLVM_ATTRIBUTE_UNUSED Bz12ModuleAnchorDestination =
    Bz12ModuleAnchorSource;

// This anchor is used to force the linker to link the CounterModule.
extern volatile int CounterModuleAnchorSource;
static int LLVM_ATTRIBUTE_UNUSED CounterModuleAnchorDestination =
    CounterModuleAnchorSource;
