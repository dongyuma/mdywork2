...
#include "CheckScopeEmptyTidyCheck.h"
...
public:
  void addCheckFactories(ClangTidyCheckFactories &CheckFactories) override {
    CheckFactories.registerCheck<FunctionParametersCheck>(
        "readability-Function-Parameters");
    CheckFactories.registerCheck<InvalidVaribaleNameCheck>(
        "readability-Invalid-Varibale-Name");
    CheckFactories.registerCheck<LoopControlCheck>(
        "readability-Loop-Control");
    CheckFactories.registerCheck<NestedCommentCheck>(
        "readability-Nested-Comment");
    CheckFactories.registerCheck<VariablenameDuplicationCheck>(
    ...
    CheckFactories.registerCheck<CheckScopeEmptyTidyCheck>
        ("readability-checkscope-empty-check");
  }
};
