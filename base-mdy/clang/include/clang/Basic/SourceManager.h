...
class SourceManager : public RefCountedBase<SourceManager> {
  ...
  /// Static analysis project directory
  std::string AnalyzeProjectDir;
...
public:
  ...
  const char *getCharacterLine(FullSourceLoc FSL,
                               bool *Invalid = nullptr) const;
  ...
  bool isInProjectFile(SourceLocation Loc) const;
