...
public:
  ...
  loc::ConcreteFloat makeFloatLocVal(const llvm::APFloat &floating) {
	  return loc::ConcreteFloat(BasicVals.getFloatValue(floating.convertToFloat()));
  }
  ...
  nonloc::ConcreteFloat makeFloatVal(float floatNumber) {
    return nonloc::ConcreteFloat(BasicVals.getFloatValue(floatNumber));
  }

  nonloc::ConcreteFloat makeFloatVal(const llvm::APFloat &floating) {
	  return nonloc::ConcreteFloat(BasicVals.getFloatValue(floating.convertToFloat()));
  }
