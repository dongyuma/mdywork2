...
/// Value representing float constant.
...
public:
 ...
 //Float don't have Complement
 //ConcreteFloat evalComplement(SValBuilder &svalBuilder) const;
...
/// Value representing float constant.
class ConcreteFloat : public Loc {
public:
	explicit ConcreteFloat(const llvm::APFloat &V) : Loc(ConcreteFloatKind, &V) {}
