...
public:
  ...
  getCrossTUDefinition(const FunctionDecl *FD, StringRef CrossTUDir,
                       StringRef IndexName, bool DisplayCTUProgress = false, bool notImport = false);
...
bool hasApproachFunctionDecl(StringRef LookupName,
      StringRef CrossTUDir,
      StringRef IndexName,
...
private:
  ...
  public:
    ...
    bool hasApproachFunction(StringRef FunctionName,
        StringRef CrossTUDir,
        StringRef IndexName,
        bool DisplayCTUProgress);
