...
public:
  ...
  virtual void InvalidPreprocessingDirective(
     Token& Tok)
  {}
...
public:
  ...
  //增加回调触发的接口，当匹配到#号时触发
  void InvalidPreprocessingDirective(
       Token& Tok)override
  {
      First->InvalidPreprocessingDirective(Tok);
      Second->InvalidPreprocessingDirective(Tok);
  }
};
