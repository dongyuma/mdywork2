...
CreateFrontendBaseAction(CompilerInstance &CI) {
  ...
  case EmitBiniouAST:          return std::make_unique<EmitBiniouASTAction>();
  case EmitYojsonAST:          return std::make_unique<EmitYojsonASTAction>();
  case EmitJsonAST:            return std::make_unique<EmitJsonASTAction>();
