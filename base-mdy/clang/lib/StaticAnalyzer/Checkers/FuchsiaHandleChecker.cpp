...
class FuchsiaHandleChecker
  ...
  BugType LeakBugType{this, "Fuchsia 处理泄露", "Fuchsia 处理错误",
                      /*SuppressOnSink=*/true};
  BugType DoubleReleaseBugType{this, "Fuchsia 处理双重释放",
                               "Fuchsia 处理错误"};
  BugType UseAfterReleaseBugType{this, "Fuchsia 处理释放后使用",
                                 "Fuchsia 处理错误"};
  BugType ReleaseUnownedBugType{
      this, "Fuchsia 处理无主处理释放", "Fuchsia 处理错误"};
