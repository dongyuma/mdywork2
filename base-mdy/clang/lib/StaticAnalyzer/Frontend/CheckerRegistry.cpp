...
#include "CheckScope/CheckScopeCheckers.h"
#endif
...
#ifdef BUILIT_IN_SCOPE_CHECKERS
  checkScopeCheckersShouldRegist();
  registCheckScopeBuiltinCheckers(this);
#endif
...
std::string CheckerRegistry::getCheckScopeSignStr()
{
	std::string res = CHECK_SCOPE_SIGN_STR;
    return res;
}
