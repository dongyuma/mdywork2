...
static InputKind ParseFrontendArgs(FrontendOptions &Opts, ArgList &Args,
  ...
  if (const Arg *A = Args.getLastArg(OPT_Action_Group)) {
    ...
    case OPT_emit_biniou_ast:
      Opts.ProgramAction = frontend::EmitBiniouAST; break;
	case OPT_emit_yojson_ast:
		Opts.ProgramAction = frontend::EmitYojsonAST; break;
	case OPT_emit_json_ast:
		Opts.ProgramAction = frontend::EmitJsonAST; break;
...
static bool isStrictlyPreprocessorAction(frontend::ActionKind Action) {
  ...
  case frontend::EmitBiniouAST:
  case frontend::EmitYojsonAST:
  case frontend::EmitJsonAST:
