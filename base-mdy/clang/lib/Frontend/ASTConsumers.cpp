...
#include "clang/AST/ASTExporter.h"
...
std::unique_ptr<ASTConsumer> 
clang::CreateASTExporter(const CompilerInstance &CI, 
    ASTExporterOutputFormat OutPutFormat, 
    std::unique_ptr<raw_ostream> OS)
{
	return std::make_unique<ExporterASTConsumer>(CI, OutPutFormat, std::move(OS));
}
